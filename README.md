...
- **总览**:KPI、**安全健康分仪表**、趋势图(7/14/30 日切换)、攻击类型环形图、**攻击雷达**(实时光点扫描)、SSE 实时事件流(多标签页同步)、**新手引导**
...
- **体验细节**:**命令面板 Ctrl+K**(跳转/搜索告警/执行操作)、键盘快捷键(1-6、?、Esc)、实时连接状态指示、**告警分页**、**标签页标题未读数**、gzip 压缩、自定义 404 页

## 📄 其他页面

- **docs.html** — 快速开始指南 + REST API 参考(12 个端点)
- **status.html** — 系统组件状态页(可用性历史条)
- **404.html** — 品牌风格 404 页
...
```
nexus-security/
├── index.html / login.html / register.html / dashboard.html / docs.html / status.html / 404.html
